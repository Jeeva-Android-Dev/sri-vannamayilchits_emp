        ...
        private void drawText(Canvas canvas, List<CircleGraph> circleGraphList) {
            if (anim == 1) {
                ...
                for (CircleGraph circleGraph : circleGraphList) {
                    ...
                    String a = String.valueOf(circleGraph.getAngleArr());
                    Locale curlocale = new Locale("en", "IN");
                    Double d = java.lang.Double.parseDouble(a.trim());
                    String converted_string = NumberFormat.getNumberInstance(curlocale).format(d);
                    ...
                    canvas.drawText(converted_string, rotateDot.x, rotateDot.y, textPaint);
                }
            }
        }
